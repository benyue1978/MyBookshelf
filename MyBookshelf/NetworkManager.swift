...
class NetworkManager {
    ...
    private func parseHTML(data: Data, isbn: String) -> Book {
        // 这里应该实现实际的HTML解析逻辑
        // 为了演示，我们返回一个假的Book对象
        return Book(title: "Sample Book", author: "Sample Author", isbn13: isbn, isbn10: "", publisher: "Sample Publisher", publishDate: "2023", coverImageURL: nil, isInReadingList: true)
    }
}
